        ...
        <div className=' dark:bg-black dark:text-white px-5 md:px-20 py-20'>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
                <Tilt options={defaultOptions}>
                    <div className='flex border border-white items-center justify-center space-x-4 shadow-md hover:shadow-xl  hover:shadow-cyan-400 rounded-lg p-4'
                ...
                <Tilt options={defaultOptions}>
                    <div className='flex border border-white items-center justify-center  space-x-4 shadow-xl hover:shadow-xl  hover:shadow-cyan-400 rounded-lg p-4 '
