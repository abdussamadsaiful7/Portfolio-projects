        ...
        <div className='py-10'>
            ...
            <div>
                <div className='grid grid-cols-2 md:grid-cols-4 md:px-24'>
                    <div className=' border border-white mx-auto rounded-full shadow-md hover:shadow-xl hover:shadow-blue-600 transition duration-700 ease-in-out p-2 tooltip  tooltip-bottom' data-aos="fade-up"
