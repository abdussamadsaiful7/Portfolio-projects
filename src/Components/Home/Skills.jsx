        ...
        <div className='py-10'>
            ...
            <div>
                <div className='grid grid-cols-2 md:grid-cols-4 md:px-24'>
                    <div className=' border border-white mx-auto rounded-full shadow-md hover:shadow-xl hover:shadow-cyan-400 transition duration-700 ease-in-out p-2 tooltip  tooltip-bottom' data-aos="fade-up"
                ...
                <div className='text-center mt-6'>
                    <Link to='/skillsDetails'><button className="btn rounded-none btn-sm btn-outline border-cyan-400 text-cyan-400 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-cyan-400">Details</button></Link>
                </div>
            </div>
        </div>
    );
