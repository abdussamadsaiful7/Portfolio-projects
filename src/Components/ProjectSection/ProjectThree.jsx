            ...
            <div className='relative'>
                <div className=' border border-white shadow-md hover:shadow-xl hover:shadow-blue-600  md:mx-36 my-20' data-aos="fade-right" data-aos-duration="3000">
                    ...
                    <div className='flex items-center justify-end space-x-4 p-6'>
                        <Link to='https://github.com/abdussamadsaiful7/Polyglot-Academy-client' target="_blank"><button className='btn btn-sm btn-outline border-blue-600 text-blue-600 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-blue-600'>github</button></Link>

                        <Link to='https://github.com/abdussamadsaiful7/Polyglot-Academy-server' target="_blank"><button className='btn btn-sm btn-outline border-blue-600 text-blue-600 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-blue-600'> Server</button></Link>
