                ...
                <div>
                    <nav className="flex items-end space-x-4">
...

                        {
                            user ?
                                <>
                                    <a className="hidden md:inline-block text-gray-500 hover:text-white hover:bg-black p-3"><Link onClick={handleLogout}>Logout</Link></a>
                                ...
                                :
                                <a className="hidden md:inline-block text-gray-500 hover:text-white hover:bg-black p-3"> <Link to='/login'>Login</Link></a>
                        }
